...
import { Cross, Heart, Eye, EyeOff } from "lucide-react"
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="attendance-card">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl text-card-foreground">Faculty Login</CardTitle>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="text-center space-y-2">
                ...
                <p className="text-xs text-muted-foreground">For technical support, contact the IT department</p>
              </div>
            </form>
          </CardContent>
        </Card>
